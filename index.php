...
<div class="swiper features-slider">
  ...
  <section class="section section-light">
    <div class="container steps-container">
      <div class="seporater seporater-section-light">
      </div>
  ...
  <section class="section-production">
    <div class="container">
      <div class="seporater seporater-production">
      </div>
  ...
  <!-- section -->
  <section class="section clients clients-section">
    <div class="container"> 
      <div class="seporater clients-seporater"></div>
      <div class="clients-wrapper">
        <div class="clients-content">
          <h2 class="section-title clients-title ">Производим аэрозольную продукцию для разных сфер
          </h2>
  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-top">
        ...
        <div class="footer-info footer-info-one">
          <svg class="phone-icon"  width="24" height="24">
            <use href="img/sprite.svg#mark"></use>
          </svg>
    ...
    <hr color="#EBEBF0" class="footer-seporater">
      <div class="container">
      ...
      <!-- /.container -->
      <hr color="#EBEBF0" class="footer-seporater last-seporater">
      <div class="container">
       <div class="footer-wrapper">
        ...
        <div class="footer-author">
          <span class="made-in ">Сделано в</span> <span class="design" >Дизайн и разработка:</span>
