...
<div class="swiper features-slider">
  <!-- обертка слайдера -->
  <ul class="swiper-wrapper header-features <?= $header_features_color ?>">
    <!-- слайды -->
    <li class="swiper-slide header-features-item <?= $border_color ?>">
    ...
    <li class="swiper-slide header-features-item <?= $border_color ?>"><svg   width="36" height="36">
